    ...
    <div className="min-h-screen" style={{ backgroundColor: colors.bg }}>
      ...
      <section id="catalog" className="py-12 md:py-16" style={{ backgroundColor: colors.bgAlt }}>
        <div className="max-w-7xl mx-auto px-4 lg:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-7xl mx-auto px-4 md:px-0">
            {products.map((product) => (
              ...
              >
                <div className="w-full p-8 md:p-10 flex flex-col md:flex-row gap-8 items-center md:items-stretch">
                  <div className="w-full md:w-[35%] shrink-0">
                    <div 
                      className="w-full aspect-[3/4] flex items-center justify-center relative overflow-hidden rounded-lg shadow-inner" 
                      style={{ backgroundColor: colors.bgAlt }}
                    >
                      <div className="absolute inset-0 flex items-center justify-center p-6">
                        <product.icon className="w-full h-full max-w-[5.5rem] max-h-[5.5rem]" style={{ color: colors.accent }} />
                      </div>
                    </div>
                  </div>
